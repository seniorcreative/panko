...
const timeline = [
  ...
  },
  {
    ...
    description:
      "Became Digital Technical Lead at Caramel Creative, building CMS platforms that drove donation and sales uplifts across clients.",
  },
  {
    year: "2015",
    title: "Innovation & Patents",
    description:
      "Lead Software Engineer at Health& - architected HealthTech systems, secured patents, and pitched to government and investors.",
  },
  {
    year: "2016-21",
    title: "Scale Mastery",
  ...
  },
  {
    ...
    description:
      "Senior Engineer at Iress managing 1M+ user deployments. Mastered security, component libraries, and large-scale mobile migrations.",
  },
  {
    year: "2025",
        ...
        <section className="container mx-auto px-6 py-20 text-center">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <p className="text-xl md:text-2xl text-slate-300 leading-relaxed">
              ...
              If you&rsquo;re trying to launch something quickly, I&rsquo;ll be your
              co-pilot who can navigate technical decisions.
              <span className="text-blue-300 font-medium">
                <br />
                We&rsquo;ll code together so you learn while we build. (I&rsquo;ll learn with you).
              </span>
            </p>
          </div>
