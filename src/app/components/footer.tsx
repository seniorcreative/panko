...
export default function Footer({ fonts }: { fonts: any[] }): JSX.Element {
  ...
  return (
    <footer className="w-full py-4 px-4 bg-white border-t border-gray-200">
        ...
        <div className="flex md:flex-row justify-between items-center gap-4">
          <div className="flex-1">
            <div className="flex gap-4 items-center">
              ...
              <a
                href="https://www.instagram.com/panko.digital"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:opacity-70 transition-opacity"
              ...
              <a
                href="https://facebook.com/panko.geelong"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:opacity-70 transition-opacity"
                aria-label="Facebook"
          ...
          <div className="flex-1 flex justify-end">
            ...
            >
              ...
              site by <strong className="font-bold text-gray-800">panko</strong>
            </a>
          </div>
        </div>
      </div>
